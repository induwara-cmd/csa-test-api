...
public final class CampusStore {
  ...
  private final ConcurrentHashMap<String, CopyOnWriteArrayList<SensorReading>> readingsBySensorId =
  ...
  public SensorReading addReading(String sensorId, SensorReading input) {
    ...
    CopyOnWriteArrayList<SensorReading> list =
        readingsBySensorId.computeIfAbsent(sensorId, id -> new CopyOnWriteArrayList<>());
